...
# recursive test cases have index parameter
        assert linear_search(names, 'Winnie',0) == 0
        assert linear_search(names, 'Kojin',0) == 1
        assert linear_search(names, 'Brian',0) == 2
        assert linear_search(names, 'Nabil',0) == 3
        assert linear_search(names, 'Julia',0) == 4
        assert linear_search(names, 'Alex',0) == 5
        assert linear_search(names, 'Nick',0) == 6
    ...
    def test_linear_search_with_items_not_in_list(self):
        ...
        assert linear_search(names, 'Jeremy',0) is None
        assert linear_search(names, 'nobody',0) is None
    ...
    def test_binary_search_with_items_in_list(self):
        ...
        # assert binary_search(names, 'Alex',0,len(names)-1)== 0
        # assert binary_search(names, 'Brian',0,len(names)-1) == 1
        # assert binary_search(names, 'Julia',0,len(names)-1) == 2
        # assert binary_search(names, 'Kojin',0,len(names)-1) == 3
        # assert binary_search(names, 'Nabil',0,len(names)-1) == 4
        # assert binary_search(names, 'Nick',0,len(names)-1) == 5
        # assert binary_search(names, 'Winnie',0,len(names)-1) == 6
...
# recursive test cases
    ...
    def test_binary_search_with_items_not_in_list(self):
        ...
        # assert binary_search(names, 'Jeremy',0,len(names)-1) is None
        # assert binary_search(names, 'nobody',0,len(names)-1) is None
